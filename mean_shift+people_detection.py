...
#track_window2 = np.array([[pick[i,0], pick[i,1], pick[i,0]+10,pick[i,1]+100] for i in range(pick.shape[0])])
track_window2 = np.array([[pick[0,0], pick[0,1], pick[0,0]+10,pick[0,1]+10],[pick[1,0], pick[1,1], pick[1,0]+10,pick[1,1]+10]])
