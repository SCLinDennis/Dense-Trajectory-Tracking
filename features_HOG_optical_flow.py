...
ap.add_argument("-v", "--video",default="D://Videos/person01_boxing_d1_uncomp.avi", help="Path to the file")
...
while True:
    ...
    r2 = 400.0 / frame_gray_tmp.shape[1]
    dim2 = (400, int(frame_gray_tmp.shape[0] * r2))
    frame_gray = cv2.resize(frame_gray_tmp, dim2, interpolation = cv2.INTER_AREA)
    
    
    r3 = 400.0 / frame_tmp.shape[1]
    dim3 = (400, int(frame_tmp.shape[0] * r3))
